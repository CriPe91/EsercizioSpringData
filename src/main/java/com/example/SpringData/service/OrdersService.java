...
public class OrdersService {
    ...
    @Autowired @Qualifier("topping_tomato") ObjectProvider<Topping> topping_tomatoProvider;
    @Autowired @Qualifier("topping_cheese") ObjectProvider<Topping> topping_cheeseProvider;

    public Topping createTomato(){
        return topping_tomatoProvider.getObject();
    }

    public Topping createCheese(){
        return topping_cheeseProvider.getObject();
    }
